...
class Actor(nn.Module):
    def __init__(self, args):
        ...
        self.fc0 = FeatureExtractor(args.state_dim, 128)#128 #512
        #num_of_features=128
        self.fc1 = nn.Linear(128, args.hidden_width)#128
    ...
    def forward(self, s):
        s = self.activate_func(self.fc0(s))
...
class Critic(nn.Module):
    def __init__(self, args):
        ...
        self.fc0 = FeatureExtractor(args.state_dim, 128)#512
        self.fc1 = nn.Linear(128, args.hidden_width)
        self.fc2 = nn.Linear(args.hidden_width,args.hidden_width)
...
class PPO_discrete:
    def __init__(self, args):
        ...
        self.PriorityReplayBuffer=args.PriorityReplayBuffer
    ...
    def choose_action(self, s):
        ...
        # print("a_prob",a_logprob)
        # print("a",a)
        # input()
        return a.numpy()[0], a_logprob.numpy()[0]

    def update(self, replay_buffer, total_steps):
        if self.PriorityReplayBuffer==True:
